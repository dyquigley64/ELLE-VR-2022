...
public class GameMenu : MonoBehaviour
{
    ...
    public BeginMethod onTutorialGame;
        ...
        if (!inGame)
        {
            ...
            if (!finishedGame)
            {
                if (gameModeCoverLockedOut == false)
                {
                    ...
                    if (VRInput.rightTrigger + VRInput.leftTrigger > 0.95f && triggerCounter == 0)
                    {
                        triggerCounter+=1;
                    ...
                    else if(VRInput.rightTrigger + VRInput.leftTrigger > 0.95f && triggerCounter == 1)
                    {
                        triggerCounter += 1;
                        currentGameMode = currentGameMode == GameMode.Endless ? GameMode.Tutorial : GameMode.Endless;
                        gameModeText.text = currentGameMode == GameMode.Endless ? "Endless" : "Tutorial";
                        gameModeCoverLockedOut = true;
                        gameModeCover.fillAmount = 0;
                        gameModeUncover.fillAmount = 1;
                    ...
                    else if(VRInput.rightTrigger + VRInput.leftTrigger > 0.95f && triggerCounter == 2)
                    {
                        triggerCounter = 0;
                        currentGameMode = currentGameMode == GameMode.Tutorial ? GameMode.Quiz : GameMode.Tutorial;
                        gameModeText.text = currentGameMode == GameMode.Tutorial ? "Tutorial" : "Quiz";
                        gameModeCoverLockedOut = true;
                        gameModeCover.fillAmount = 0;
                        gameModeUncover.fillAmount = 1;
...
public enum GameMode { Quiz, Endless, Tutorial }